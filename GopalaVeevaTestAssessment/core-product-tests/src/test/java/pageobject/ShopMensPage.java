...
public class ShopMensPage {
	...
	public By jacketsRadioButton = By.cssSelector("a[data-trk-id='side-nav-jackets-all-departments-boxes-15674']");
	
	
	//public By selectedJacketOption = By.cssSelector("a[data-trk-id='jackets'][aria-label='Remove Jackets filter']");

	public By selectedJacketOption = By.cssSelector("a[data-trk-id='side-nav-jackets-all-departments-boxes-15674'][aria-label='Remove Jackets filter']");
	//public By closeFreeShipping = By.cssSelector("i[class='icon icon-close-alt'][aria-label='Close Pop-Up']");
	public By closeFreeShipping = By.cssSelector("i[aria-label='Close Pop-Up']");
